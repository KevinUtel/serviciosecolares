...
const infoTitulacion = [
    ...
    1.-Certificado electrónico: tarda aproximadamente de 1 a 3 meses en obtenerse  autenticado.</br></br>
    ...
    el servicio social (En caso de maestría no es necesario)no tener adeudos, documentación completa  y contar  con
    el pago de titulación.</br></br>
    ...
    Titulo: 'Licenciatura', 
    Texto:`
    El proceso de certificación demora de 1 a 3 meses y el documento se comparte en digital en archivo pdf y xml </br></br>
    ...
    Texto:`
        ...
        Registro de título:demora de 1 a 2 meses,se notifica por correo electrónico una vez que concluye y a
        partir de este momento se puede iniciar el tramite de cedula profesional </br></br>
    ...
    Registro de título:demora de 1 a 2 meses,se notifica por correo electrónico una vez que concluye y a partir de este 
    momento se puede iniciar el tramite de cedula profesional </br></br>
...
const bloqueImagenTexto = [
    ...
    4.-Expedición de título honorífico( documento físico simbólico): Tiempo aproximado de 3 meses.
    </br></br>
    5.-Certificado de programa académico: Tiempo estimado:
    </br></br>
    6.-Envío internacional: 10 dias a partir de que se cuente con la documentación elaborada
    `, 
    id: 'btlataml'
...
const InfoAvisoRojo = [
    ...
    Texto: `
    Es importante aclarar que, si no se cuenta con un expediente físico en el archivo UTEL y no cumple con alguno de los estatutos mencionados, el proceso de 
